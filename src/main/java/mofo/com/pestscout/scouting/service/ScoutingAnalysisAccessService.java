...
public class ScoutingAnalysisAccessService {
    ...
    public Farm loadFarmAndEnsureViewer(UUID farmId) {
        ...
        throw new ForbiddenException("You do not have permission to access photo analysis for this farm.");
    }
    ...
    public Farm loadFarmAndEnsureManager(UUID farmId) {
        ...
        throw new ForbiddenException("You do not have manager access to photo analysis for this farm.");
    }
