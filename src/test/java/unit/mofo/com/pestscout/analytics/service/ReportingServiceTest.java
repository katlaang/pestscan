...
class ReportingServiceTest {
    ...
    void getSessionReport_returnsDetailsFromService() {
        ...
        ScoutingSessionDetailDto detailDto = buildDetailDto(sessionId);
    ...
    private mofo.com.pestscout.auth.model.User buildScout() {
        return mofo.com.pestscout.auth.model.User.builder()
                ...
                .phoneNumber("123")
                .role(mofo.com.pestscout.auth.model.Role.SCOUT)
                .build();
    }

    private ScoutingSessionDetailDto buildDetailDto(UUID sessionId) {
